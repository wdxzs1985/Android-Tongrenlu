...
public class AudioFocusHelper implements AudioManager.OnAudioFocusChangeListener {
    ...
    public AudioFocusHelper(Context ctx, MusicFocusable focusable) {
        this.mAM = (AudioManager) ctx.getSystemService(Context.AUDIO_SERVICE);
        this.mFocusable = focusable;
    }

    /** Requests audio focus. Returns whether request was successful or not. */
    public boolean requestFocus() {
        return AudioManager.AUDIOFOCUS_REQUEST_GRANTED == this.mAM.requestAudioFocus(this,
    ...
    public boolean abandonFocus() {
        return AudioManager.AUDIOFOCUS_REQUEST_GRANTED == this.mAM.abandonAudioFocus(this);
    }
